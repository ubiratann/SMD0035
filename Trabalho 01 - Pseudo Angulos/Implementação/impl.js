...
def draw():
    ...
    if(vetorY.x <= LARGURA_CANVAS and vetorY.x >= 0 and vetorY.y <= ALTURA_CANVAS and vetorY.y >= 0 ):
        ...
        if(vetorX.verificarNulo() == False and vetorY.verificarNulo() == False):
            ...
            text('Angulo pelo produto escalar {}'.format(vetorX.anguloEscalar(vetorY)), 150,  250);
            text('Angulo pelo produto vetorial {}'.format(vetorX.anguloVetorial(vetorY)), 150, 270);
    else:
